    ...
    <div className="min-h-screen flex flex-col md:flex-row">
      <div className="hidden md:flex w-1/2 bg-gradient-to-br from-orange-200 via-white to-sky-200 text-slate-900 items-center justify-center p-8">
        <div className="max-w-lg text-center">
          ...
          <p className="mt-4 text-lg text-slate-700">Create your account and start building streaks today.</p>
        </div>
      </div>
        ...
        <div className="w-full max-w-md">
          <Card>
            <CardHeader className="space-y-1">
              ...
              <CardDescription className="text-center">Enter your details to start tracking your skills</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                ...
                <Button variant="outline" className="w-full flex items-center justify-center gap-3" onClick={handleGoogleSignUp}>
